...
def clean_fed_excel(excel_path, output_dir):
    ...
    print(f"🎬 Starting Preprocessor (Build #816 - Full Macro Suite)... ")
    ...
    # UPDATED MAPPING: Explicitly capturing FFR, PCE, and PCXFE
    mapping = {
        'unemp': 'unemp', 
        'lur':   'unemp', 
        'gdp':   'gdp', 
    ...
    for sheet in xls.sheet_names:
        ...
        try:
            ...
            for col in df.columns:
                ...
                # Target columns usually end in F0 (forecast) or just the name
            ...
            # Filter logic: Values > 1000 are usually date stamps (e.g. 20240101)
            ...
            for d in target_dirs:
                if os.path.exists(d):
                    ...
                    print(f"      🚀 SAVED {var_name.upper()}: {p}")
